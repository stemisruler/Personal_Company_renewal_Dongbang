...
const sub = document.getElementsByClassName('sub'); // ul>li>ul.sub
const headerGnb = document.querySelector('.menu'); // gnb
const subBg = document.querySelector('.sub-menu-bg'); // 서브메뉴 뒷배경
...
const setSubMenuHeight = () => {
    subBg.style.height = '220px';
    Array.from(sub).forEach((item, index) => {
